...
local PLANET_TRUNK_WISHLISTS = {
    nauvis = {
        ...
        { name = "electric-furnace",            count = 400,  quality = "legendary" },
        { name = "oil-refinery",                count = 20,   quality = "legendary" },
        { name = "chemical-plant",              count = 80,   quality = "legendary" },
        ...
        { name = "productivity-module-3",       count = 400,  quality = "legendary" },
